...
wiring time. Retries capped and paced by a floor delay, a timeout that is one budget across
every attempt and every delay between them, a base URL validated at wiring time,
