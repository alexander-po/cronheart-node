...
const HELD_AS_CONSTANTS = {
  ...
  'constraints.signup.email.max': 'SIGNUP_EMAIL_MAX_LENGTH',
  'api.signup.user_code_pattern': 'SIGNUP_USER_CODE_PATTERN',
}
